...
#| echo: FALSE
#| warning: FALSE
#| fig.cap: "\\label{fig:mp_sim_multi_ungroup}Mosaic Plot of Hypothetical High-Dimensional Aggregated Ordinal Data without accounting for $G$ and $Z$."
#| fig.height: 3.5
#| fig.width: 5
mosaicplot(~ X + Y, data = sim_data, main = "")
```
...
#| echo: FALSE
#| warning: FALSE
#| fig.cap: "\\label{fig:BECCR_sim_multi_ungroup}BECCR Prediction Bubble Plot of Hypothetical High-Dimensional Aggregated Ordinal Data without accounting for $G$ and $Z$."
#| fig.height: 3
#| fig.width: 5
